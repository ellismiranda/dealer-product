...
var mongodb = require('botkit-storage-mongo')({mongoUri: process.env.mongodb_URI, tables: ['optional','list', 'of', 'custom','tables', 'to', 'add']});
...
// Set up Facebook "thread settings (now, messenger profile)" such as get started button, persistent menu
